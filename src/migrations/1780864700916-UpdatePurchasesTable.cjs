 ...
 */
module.exports = class UpdatePurchasesTable1780864700916 {
    name = 'UpdatePurchasesTable1780864700916'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`purchases\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`purchases\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`purchases\` ADD \`id\` int NOT NULL PRIMARY KEY AUTO_INCREMENT`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`purchases\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`purchases\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`purchases\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`payments\` DROP COLUMN \`mp_raw_response\``);
